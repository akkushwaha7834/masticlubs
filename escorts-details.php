            ...
            <div class="col-md-3">
                <div class="sticky-top z-1 top-70">
                    <div class="d-flex flex-column gap-3 mb-4">
                        ...
                        <a href="#" class="btn bttn btn-primary whatsapp-clr"><i class="fa-brands fa-whatsapp"></i> Whatsapp</a>
                    </div>
                    <div class="share-ad text-center">
                        <h5 class="mb-3">Share ad</h5>
                        <a href="#" class="btn btn-success whatsapp-clr rounded-circle">
                            ...
                            <div id="carouselExample" data-bs-ride="carousel" data-bs-interval="2000" class="h-100 carousel slide">
                                <div class="h-100 carousel-inner">
                                    ...
                                    <div class="h-100 carousel-item">
                                        <a href="./escorts-details.php">
                                            <img src="https://in.masticlubs.com/uploads/model_image/252149/thumbnail/745721000000801-9-426x493.jpg" class="img-fluid rounded-start w-100 h-100 object-fit-cover" alt="Cash On Delivery Noida College Girls Student And Auntie In Aerocity">
                                        </a>
                                    </div>
                                    <div class="h-100 carousel-item">
                                        <a href="./escorts-details.php">
